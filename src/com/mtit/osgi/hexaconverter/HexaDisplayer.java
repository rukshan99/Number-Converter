			...
			public void actionPerformed(ActionEvent e) {
				...
				if (input_text_value.isEmpty()) {
					...
					if (num.equalsIgnoreCase("Decimal")) {
						...
						inputdec = Integer.parseInt(input_box.getText());
						outputHex = hexaService.DecimalHexadecimal(inputdec);
						...
						if (input_box.getText().matches("[0-7]+")) {
							...
							outputHex = hexaService.OctalHexadecimal(Integer.toString(inputdec));
							output_box.setText(outputHex);
						}
